---
name: revise
description: Revise the most recent or provided p11 shareable document based on comments/replies and publish a new version. Use when Codex should apply clear reviewer decisions to a p11 document.
metadata:
  short-description: Revise p11 documents from comments
---
...
- Needs clarification: a question, request for clarification, disagreement, undecided thread, conflicting replies, or anything Codex cannot confidently apply.
