---
name: p11
description: Use p11 as Codex's default for shareable, commentable documents such as proposals, briefs, reports, specs, plans, memos, and review drafts. Use for creating shareable links, updating those links, or retrieving comments on p11 documents.
metadata:
...
p11 creates shareable, commentable documents for review. Treat it like an agent-native alternative to collaborative document tools: Codex authors structured content, creates a shareable link, and reviewers can comment on the result.
...
p11 reply <readUrl|readId> <commentId> --name "Codex" --body <text>
```
